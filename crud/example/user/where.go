...
// PicEQ  =
func PicEQ(arg []byte) UserWhere {
	return UserWhere(func(s *xsql.Selector) {
		s.Where(xsql.EQ(Pic, arg))
	})
}

// PicNEQ <>
func PicNEQ(arg []byte) UserWhere {
	return UserWhere(func(s *xsql.Selector) {
		s.Where(xsql.NEQ(Pic, arg))
	})
}

// PicLT <
func PicLT(arg []byte) UserWhere {
	return UserWhere(func(s *xsql.Selector) {
		s.Where(xsql.LT(Pic, arg))
	})
}

// PicLET <=
func PicLTE(arg []byte) UserWhere {
	return UserWhere(func(s *xsql.Selector) {
		s.Where(xsql.LTE(Pic, arg))
	})
}

// PicGT >
func PicGT(arg []byte) UserWhere {
	return UserWhere(func(s *xsql.Selector) {
		s.Where(xsql.GT(Pic, arg))
	})
}

// PicGTE >=
func PicGTE(arg []byte) UserWhere {
	return UserWhere(func(s *xsql.Selector) {
		s.Where(xsql.GTE(Pic, arg))
	})
}

// PicIn in(...)
func PicIn(args ...[]byte) UserWhere {
	return UserWhere(func(s *xsql.Selector) {
		if len(args) == 0 {
			s.Where(xsql.False())
			return
		...
		s.Where(xsql.In(Pic, v...))
	})
}

// PicNotIn not in(...)
func PicNotIn(args ...[]byte) UserWhere {
	return UserWhere(func(s *xsql.Selector) {
		if len(args) == 0 {
			s.Where(xsql.False())
			return
